...
import bzh.org.fxyz.shapes.primitives.CurvedSpringMesh;
import bzh.org.fxyz.shapes.primitives.KnotMesh;
import bzh.org.fxyz.shapes.primitives.helper.TriangleMeshHelper.SectionType;
import bzh.org.fxyz.utils.Axes;
...
//        spring.setTextureModeVertices3D(256*256,dens);
    // NONE
        ...
        Target in spring
        */
        bzh.org.fxyz.geometry.Point3D locOrigin = knot.getOrigin();
        Point3D gloOrigin=knot.localToScene(new Point3D(locOrigin.x,locOrigin.y, locOrigin.z));
        bzh.org.fxyz.geometry.Point3D locTarget1 = spring.getOrigin();
        ...
        */
        ...
        if(counter.get()>0){
            ...
            */
            // triangle mesh
            bzh.org.fxyz.geometry.Point3D gloOriginInLoc1 = new bzh.org.fxyz.geometry.Point3D((float)gloOriginInLoc.getX(),(float)gloOriginInLoc.getY(),(float)gloOriginInLoc.getZ());
            bzh.org.fxyz.geometry.Point3D gloDirection1 = new bzh.org.fxyz.geometry.Point3D((float)gloDirection.getX(),(float)gloDirection.getY(),(float)gloDirection.getZ());
