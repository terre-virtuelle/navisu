 ...
 */
public class BCNISD_ShapefileLoader
        extends ShapefileLoader {

    private final List<BeaconIsolatedDanger> beacons;
    PointPlacemarkAttributes attrs;
    private Set<Entry<String, Object>> entries;
    private BeaconIsolatedDanger beacon;

    public BCNISD_ShapefileLoader() {
    ...
    protected Renderable createPoint(ShapefileRecord record, double latDegrees, double lonDegrees,
        ...
        beacons.add(beacon);
        beacon = new BeaconIsolatedDanger();
        ...
        String label = "BeaconIsolatedDanger "  + "\n"
    ...
    public List<BeaconIsolatedDanger> getBeacons() {
        return beacons;
    }
