 ...
 * @author serge
 */
public class CoastalineDBLoader
            extends ResultSetDBLoader {

    public CoastalineDBLoader(Connection connection, String acronym) {
    ...
    public List<String> retrieveGeometriesIn(double latMin, double lonMin,
        ...
        try {
            ...
            Logger.getLogger(CoastalineDBLoader.class.getName()).log(Level.SEVERE, ex.toString(), ex);
        }
        return polyString;
    }
