...
public class Configuration {
    ...
    public static void init() {
        ...
        if (!Files.exists(Paths.get(navisuDir + "/privateData/svg"), LinkOption.NOFOLLOW_LINKS)) {
            try {
                Files.createDirectory(Paths.get(navisuDir + "/privateData/svg"));
            } catch (IOException ex) {
                Logger.getLogger(Configuration.class.getName()).log(Level.SEVERE, ex.toString(), ex);
            }
        }
        if (!Files.exists(Paths.get(navisuDir + "/privateData/wkt"), LinkOption.NOFOLLOW_LINKS)) {
            try {
                Files.createDirectory(Paths.get(navisuDir + "/privateData/wkt"));
            } catch (IOException ex) {
                Logger.getLogger(Configuration.class.getName()).log(Level.SEVERE, ex.toString(), ex);
            }
        }
