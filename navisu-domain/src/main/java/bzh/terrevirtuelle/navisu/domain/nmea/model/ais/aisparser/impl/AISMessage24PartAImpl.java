...
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.AISMessage24PartA;
...
class AISMessage24PartAImpl extends AISMessage24Impl implements AISMessage24PartA {
	...
	{
		return AISMessage24Impl.valid(content) && (content.getIntFromTo(PARTNUMBER_FROM,PARTNUMBER_TO) == 0);
	}
