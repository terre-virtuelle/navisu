package bzh.terrevirtuelle.navisu.domain.nmea.model.ais.provenance;
...
/** This interface provides access to information on where a particular information item 
 * (e.g., an AIS message) originally came from.
