...
/**
 * An object of this class indicates that information is interpreted as a valid
 * VDM Line.
 *
...
public class VDMLineProvenance implements Provenance {
     ...
     *
     * @param layout a string that should be added to the beginning of every
     * line
     * @return a string describing the provenance, possibly consisting of
     * multiple lines
     */
    ...
    public VDMLineProvenance() {
    }

    /**
     * Constructs a new object describing information that was interpreted as
     * AIVDMLine.
     *
