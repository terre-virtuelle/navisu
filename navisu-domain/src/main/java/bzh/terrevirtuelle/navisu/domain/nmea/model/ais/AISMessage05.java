...
/**
 * This interface represents an AIS message of type 5: Ship static and voyage
 * related data. Such messages are used by Class A shipborne and SAR aircraft
 * AIS stations to report static and voyage-related data.
 *
...
public interface AISMessage05
    ...
    /**
     * Returns an indicator for the AIS version applicable to the current
     * message.
     *
    ...
    /**
     * Returns the IMO number of the transmitting ship. See
     * <a href=http://en.wikipedia.org/wiki/IMO_ship_identification_number>Wikipedia</a>
     * for more information on IMO (International Maritime Organization)
     * numbers.
     *
     ...
     *
     * @return a String value, containing at most 7 characters, representing the
     * call sign <br>
     * "" = not available
     */
     ...
     * the name. <br>
     * "" = not available. <br>
     * For SAR aircraft, it should be set to "SAR AIRCRAFT NNNNNNN" where
    ...
    /**
     * Returns the estimated time of arrival (ETA). This can be analyzed further
     * using utility class {@link UtilsEta}.
     *
     * @return a <code>BitVector</code> value of the estimated time of arrival
     * (MMDDHHMM UTC) <br>
     ...
     *
     * @return an integer value expressing the maximum present static draught in
     * 1/10 m <br>
