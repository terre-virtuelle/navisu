...
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.AISMessage27;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.Sixbit;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.UtilsLatitude17;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.UtilsLongitude18;
 ...
 * 11	statusOfCurrentGNSSPosition             	   1	(  95,  95)
 * 12	spare                                   	   1	(  96,  96)
 *                                                   ---- +
 *                       (maximum) number of bits     96
 */
...
class AISMessage27Impl extends AISMessageImpl implements AISMessage27 {
	 ...
	 */
	public boolean getStatusOfCurrentGNSSPosition() { return statusOfCurrentGNSSPosition; }
	 ...
	 * @precondition validLength(content.length()) && AISMessageBase.getMessageId(content)==27
	 */
    public AISMessage27Impl(Sixbit content, VDMMessageProvenance prov)
	{
    	super(content, prov);
