...
public class Publisher {
    ...
    public Publisher(Identity identity, Address address, Contact contact) {
    ...
    public String toString() {
        return "Publisher{" + "identity=" + identity + ", address=" + address + ", contact=" + contact + '}';
    }
