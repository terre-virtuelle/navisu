 ...
 */
public class AISNoCompleteUserIdAnnotation implements AISAnnotation {
	private int length;

    public AISNoCompleteUserIdAnnotation() {
    }
	
	/** Constructor. 
	 * @param length actual length of mmsi
	 */
	public AISNoCompleteUserIdAnnotation(int length)
	{
		this.length = length;
	}
	...
	{
		return "Violation of standard: User Id length is " + length + " instead of 30"; 
	}
}
