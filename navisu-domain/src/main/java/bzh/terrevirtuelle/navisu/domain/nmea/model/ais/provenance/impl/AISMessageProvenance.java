 ...
 */
public class AISMessageProvenance
        implements Provenance {

    public AISMessageProvenance() {
    }
     ...
     * case, it just forward it to the provenance of the underlying VDM Message.
     */
     ...
     *
     * @param provenance the provenance of the VDMMessage object used to create
     * this AIS Message
