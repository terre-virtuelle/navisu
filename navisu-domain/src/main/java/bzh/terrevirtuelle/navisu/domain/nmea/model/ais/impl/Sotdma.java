 ...
 */
/**
 * This class represents the SOTDMA communication state as expressed in type 1
 * or 2 AIS messages. See page 40 of the standard.
 * <pre>
...
public class Sotdma extends CommunicationState {
    ...
    /**
     * Returns the slot time-out. This specifies the frames remaining until a
    ...
    /**
     * Returns the submessage. The meaning of submessage depends on the current
     * value in slot time-out as described in Table 19 on page 40 of the
     * standard.
     *
     ...
     *
     * @param offset the position in the message from where to extract
     * information
    ...
    /**
     * Generates a String representing the Sotdma message. Format: all fields
     * are shown in the order as specified by the standard separated by the
     * SEPARATOR string.
     *
     * @return
     */
