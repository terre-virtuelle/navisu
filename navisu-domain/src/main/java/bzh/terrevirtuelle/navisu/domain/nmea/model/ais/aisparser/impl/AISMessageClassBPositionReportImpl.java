...
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.AISMessageClassBPositionReport;
...
abstract class AISMessageClassBPositionReportImpl extends AISMessageImpl implements AISMessageClassBPositionReport {
	 ...
	 * @return a double value representing the longitude in degrees (&plusmn;180&deg;, East = positive, West = negative). <br>
	 ...
	 * @return a double value representing the latitude in degrees (&plusmn;90&deg;, North = positive, South = negative). <br>
