 ...
 * 
 */
package bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.provenance;
...
public class VDMMessageProvenance implements Provenance {
	 ...
	 * In this case, it mentions the sources that are combined to form the current VDM message. */
	...
	/** This array contains the provenance objects for all the parts of the VDM message */
