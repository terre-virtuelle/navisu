...
/**
 * <p>Classe Java pour fileSourceType complex type.
 * 
 ...
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://xmlns.oracle.com/ord/meta/exif>fileSource_t">
...
@XmlType(name = "fileSourceType", propOrder = {
    "value"
})
public class FileSourceType {

    @XmlValue
    protected FileSourceT value;
     ...
     *     
     */
    public void setValue(FileSourceT value) {
        this.value = value;
    }
