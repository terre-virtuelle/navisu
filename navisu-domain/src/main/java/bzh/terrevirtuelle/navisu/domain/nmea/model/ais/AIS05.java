...
public class AIS05 extends AIS135 {

    public AIS05() {
    }

    public AIS05(int MMSI, String device, int imo, String shipname, int shipType, float width, float length, float draught, String callsign, Calendar ETA, String destination) {
