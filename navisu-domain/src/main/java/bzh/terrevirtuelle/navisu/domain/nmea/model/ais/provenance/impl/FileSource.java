...
/**
 * An object of this class indicates that information is coming from a file. It
 * can report the file and the line number (in addition to the
 * {@link #getTime()} method that is required by {@link Provenance}.
 *
...
public class FileSource implements Provenance {
     ...
     * @param time the time when the information was created (in seconds from
     * January 1, 1970)
     */
