...
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.AISMessage11;
 ...
 */
class AISMessage11Impl extends AISMessageUTCReportImpl implements AISMessage11 {
	/** AISMessage11 constructor
	 * @param content AIS content
	 * @param prov the provenance of the message
	 * @precondition validLength(content.length()) && AISMessageBase.getMessageId(content)== 11
	 */
	public AISMessage11Impl(Sixbit content, VDMMessageProvenance prov) {
		super(content, prov);
		assert(getMessageID() == 11);
	}
}
