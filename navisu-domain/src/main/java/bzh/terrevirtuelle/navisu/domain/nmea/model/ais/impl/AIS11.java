...
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.AISMessage11;
...
public class AIS11 extends AISMessageUTCReportImpl implements AISMessage11 {

    /**
     * AIS11 default constructor
     */
    public AIS11() {
    }
     ...
     * AISMessageBase.getMessageId(content)== 11
     */
    public AIS11(Sixbit content, VDMMessageProvenance prov) {
        super(content, prov);
