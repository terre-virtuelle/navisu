 ...
 * <li>Similar performance for <tt>or, xor, andNot, not, copy, replace,
 * partFromTo, indexOf, clear</tt> etc.
 * </ul>
...
public class BitVector extends PersistentObject {
     ...
     * @throws	IndexOutOfBoundsException if <tt>bitIndex&lt;0 ||
     * bitIndex&gt;=size()</tt>
     */
     ...
     * <pre>((BitVector)obj).get(k) == this.get(k)</pre> must be true.
     *
     ...
     * @param procedure a procedure object taking as argument the current bit
     * index. Stops iteration if the procedure returns <tt>false</tt>, otherwise
     * continues.
     * @return <tt>false</tt> if the procedure stopped before all elements where
     * iterated over, <tt>true</tt> otherwise.
     * @throws IndexOutOfBoundsException if (<tt>size()&gt;0 && (from&lt;0 ||
     * from&gt;to || to&gt;=size())</tt>).
     */
     ...
     * @throws	IndexOutOfBoundsException if <tt>from&lt;0 || from&gt;=size() ||
     * to&lt;0 || to&gt;=size() || to-from+1<0 || to-from+1>64</tt>
     */
     ...
     * if the bit with the index <tt>bitIndex</tt>
     * is currently set; otherwise, returns <tt>false</tt>.
     *
     * <p>
     ...
     * Precondition (unchecked): <tt>bitIndex &gt;= 0 && bitIndex &lt;
     * size()</tt>.
     *
     * @param bitIndex the bit index.
     * @return the value of the bit with the specified index.
     ...
     * compute it may be described as follows.<p>
     ...
     * @exception IndexOutOfBoundsException if (<tt>size()&gt;0 && (from&lt;0 ||
     * from&gt;to || to&gt;=size())</tt>).
     */
     ...
     * @throws IndexOutOfBoundsException if <tt>size()&gt;0 && (from&lt;0 ||
     * from&gt;to || to&gt;=size() ||
     * sourceFrom<0 || sourceFrom+to-from+1>source.size()))</tt>.
     */
    ...
    /**
     * Sets the bits in the given range to the state specified by
     * <tt>value</tt>.
     * <p>
     * Optimized for speed. Preliminary performance (200Mhz Pentium Pro, JDK
