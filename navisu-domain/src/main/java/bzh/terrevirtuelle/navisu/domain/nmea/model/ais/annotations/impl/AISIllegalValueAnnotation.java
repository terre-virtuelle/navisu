...
/**
 * This class represents annotations related to deviations in value from the AIS
 * standard that are detected during parsing of AIS messages. These annotations
 * are stored in the provenance of the resulting message objects, so that they
 * can analyzed by a client program.
 *
...
public class AISIllegalValueAnnotation implements AISAnnotation {
    ...
    public AISIllegalValueAnnotation() {
    }
