...
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.AISMessage24PartB;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.Sixbit;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.UtilsDimensions30;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.UtilsShipType8;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.UtilsSpare;
import bzh.terrevirtuelle.navisu.domain.nmea.model.ais.aisparser.UtilsString;
...
class AISMessage24PartBImpl extends AISMessage24Impl implements AISMessage24PartB {
	...
	{
		return AISMessage24Impl.valid(content) && (content.getIntFromTo(PARTNUMBER_FROM,PARTNUMBER_TO) == 1);
	}
