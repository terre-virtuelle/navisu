 ...
 * @author Serge Morvan
 */
public class GpsPlotterWithRouteGpsEventsController
        extends GpsEventsController {

    GpsPlotterWithRouteController controller;

    public GpsPlotterWithRouteGpsEventsController(GpsPlotterWithRouteController controller) {
