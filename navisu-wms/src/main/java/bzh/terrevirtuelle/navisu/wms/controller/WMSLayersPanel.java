 ...
 * All Rights Reserved.
 */
package bzh.terrevirtuelle.navisu.wms.controller;
...
public class WMSLayersPanel extends JPanel
{
    ...
    protected final TreeSet<LayerInfo> layerInfos = new TreeSet<>((LayerInfo infoA, LayerInfo infoB) -> {
        ...
        public void actionPerformed(ActionEvent actionEvent)
        {
            ...
            if (((JCheckBox) actionEvent.getSource()).isSelected())
            {
                if (this.component == null){
                    ...
                    System.out.println(layerInfo.caps+"  "+layerInfo.params);
                }
    ...
    protected final void makeProgressPanel()
    {
