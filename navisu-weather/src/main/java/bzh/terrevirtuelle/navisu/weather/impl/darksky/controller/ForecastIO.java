...
public class ForecastIO {
    ...
    private static final String FORECAST_IO_URL = "https://api.darksky.net/forecast/";
    ...
    public ForecastIO(String API_KEY, String UNITS, String LANG, 
    ...
    /**
     * Sets the time for the request. Time is parsed as follows:<br>
     * [YYYY]-[MM]-[DD]T[HH]:[MM]:[SS]{+,-}[HH][MM]<br>
     * The last {+,-}[HH][MM] is the timezone<br>
     * Example:<br>
     * [2013-05-06T12:00:00-0400]<br>
     ...
     *
     * @param PROXYNAME hostname or ip of the proxy to use (e.g. "127.0.0.1").
     * If proxyname equals null, no proxy will be used.
     ...
     * information refer to the API Docs:
     * <a href="https://developer.forecast.io">https://developer.forecast.io</a>
     *
    ...
    /**
     * Returns the timezone offset in an double For more information refer to
     * the API Docs:
     * <a href="https://developer.forecast.io">https://developer.forecast.io</a>
     *
     ...
     * auto is set.<br>
     * Units can be set with constants like ForecastIO.UNITS_AUTO. For more
     * information refer to the API Docs:
     * <a href="https://developer.forecast.io">https://developer.forecast.io</a>
     *
     * @param units the units to be set. Units can set with a constant like
     * ForecastIO.UNITS_SI. (If the units are invalid the API will return an
     * error)
     */
    ...
    /**
     * Sets the language to be passed in the request. If the language is not
     * unavailable, english is set.<br>
     * Units can be set with constants like ForecastIO.LANG_ENGLISH. For more
     * information refer to the API Docs:
     * <a href="https://developer.forecast.io">https://developer.forecast.io</a>
     *
     * @param lang the language to set. this can be set with the constant
     * ForecastIO.LANG_ENGLISH (example for english). If a constant is not
     * available for a given an available API language it can be set with the
     * language code. (If the language is invalid the API will return an error)
     */
    ...
    private String urlBuilder(String LATITUDE, String LONGITUDE) {
        ...
        url.append(FORECAST_IO_URL);
        url.append(ForecastIOApiKey).append("/");
        url.append(LATITUDE.trim()).append(",").append(LONGITUDE.trim());
        if (timeURL != null) {
            url.append(",").append(timeURL.trim());
        }
        url.append("?units=").append(unitsURL.trim());
        url.append("&lang=").append(langURL.trim());
        if (excludeURL != null) {
            StringBuilder append = url.append("&exclude=").append(excludeURL.trim());
        }
        if (extend) {
     ...
     * @return True if successful
     */
    public final boolean getForecast(String LATITUDE, String LONGITUDE) {
     ...
     */
    /**
     * Parses the forecast reports for the given coordinates with the set
