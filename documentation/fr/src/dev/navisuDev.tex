...
\def\soustitre{\bf\sc Canevas de développement d'applications géo-référencées maritimes}
\def\projet{\bf\sc NaVisu}
\def\sousprojet{\bf\sc Dossier de développement}
...
\def\lechef{sm}
\def\laversion{1.1}
\def\sujet{\sc Manuel développeur} 
...
\fancyhead[CE,CO]{\sc Logiciel d'aide à la navigation maritime en 3D }
...
%--------------------------------------------------------------------------
\cfoot{\includegraphics[width=18.5cm]{images/bas-page-masterPPT_RVB_final.png}}
