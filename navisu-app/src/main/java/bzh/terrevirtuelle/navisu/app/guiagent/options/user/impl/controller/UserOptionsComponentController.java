 ...
 */
package bzh.terrevirtuelle.navisu.app.guiagent.options.user.impl.controller;

import bzh.terrevirtuelle.navisu.app.guiagent.options.server.impl.controller.*;
import bzh.terrevirtuelle.navisu.app.guiagent.GuiAgentServices;
import bzh.terrevirtuelle.navisu.app.guiagent.options.server.impl.ServerOptionsComponentImpl;
import bzh.terrevirtuelle.navisu.app.guiagent.options.user.impl.UserOptionsComponentImpl;
 ...
 *
 */
public class UserOptionsComponentController
    ...
    private final String FXML = "userOptionsController.fxml";
    private static UserOptionsComponentController INSTANCE;
    private final UserOptionsComponentImpl component;
    @FXML
    public Pane view;
    @FXML
    public Tab serialT;
    ...
    private UserOptionsComponentController(UserOptionsComponentImpl component,
        ...
        try {
            ...
            Logger.getLogger(UserOptionsComponentController.class.getName()).log(Level.SEVERE, ex.toString(), ex);
        }
    ...
    public static UserOptionsComponentController getInstance(UserOptionsComponentImpl component,
            KeyCode keyCode, KeyCombination.Modifier keyCombination,
            GuiAgentServices guiAgentServices, DataServerServices dataServerServices) {
        if (INSTANCE == null) {
            INSTANCE = new UserOptionsComponentController(component, keyCode, keyCombination,
