 ...
 */
public class GribLayer1 extends MarkerLayer {

    protected final static Logger LOGGUER = Logger.getLogger(GribLayer1.class.getName());

    protected GribModel model;

    public GribLayer1(GribModel model) {
