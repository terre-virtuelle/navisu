 ...
 */
package bzh.terrevirtuelle.navisu.instruments.locators.ais;
...
import bzh.terrevirtuelle.navisu.instruments.locators.ais.controller.AisLocatorControllerWithDPAgent;
...
public class AisLocator {
    ...
    protected final void updateAisPanel(TShip ship) {
        Platform.runLater(() -> {
