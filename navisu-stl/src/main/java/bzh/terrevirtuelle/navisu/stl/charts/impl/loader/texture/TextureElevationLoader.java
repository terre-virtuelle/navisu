 ...
 * All Rights Reserved.
 */
package bzh.terrevirtuelle.navisu.stl.charts.impl.loader.texture;
...
public class TextureElevationLoader {
    ...
    public TextureElevationLoader(List<? extends Position> positions, int index) {
        this.index = index;
    ...
    public final void doSaveImage() {
        ...
        try {
            ...
            Logger.getLogger(TextureElevationLoader.class.getName()).log(Level.SEVERE, ex.toString(), ex);
        }
    }
    ...
    private void writeImageToFile(Sector sector, BufferedImage image, String outDir) {
        ...
        try {
            ...
            Logger.getLogger(TextureElevationLoader.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
