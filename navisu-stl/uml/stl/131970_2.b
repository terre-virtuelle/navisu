class SLCONS_Stl_ShapefileWriter
!!!142082.java!!!	SLCONS_Stl_ShapefileWriter(in filename : String, inout polyEnveloppe : Polygon, in scaleLatFactor : double, in scaleLonFactor : double, in tileSide : double)
...
!!!142210.java!!!	createPolylineAttributes(inout record : ShapefileRecord) : ShapeAttributes
        this.record = record;
...
!!!142338.java!!!	createPolygonAttributes(inout record : ShapefileRecord) : ShapeAttributes
        Color color = Color.BLACK;
        ShapeAttributes normalAttributes = new BasicShapeAttributes();
        normalAttributes.setInteriorMaterial(new Material(color));
        return normalAttributes;
!!!142466.java!!!	createBuffers(inout latLon : Iterable<? extends LatLon>) : void
...
!!!142594.java!!!	createSlCons(inout positionList : List<Position>) : void
