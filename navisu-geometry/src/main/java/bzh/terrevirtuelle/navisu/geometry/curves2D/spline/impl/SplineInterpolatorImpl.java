 ...
 */
package bzh.terrevirtuelle.navisu.geometry.curves2D.spline.impl;
...
public class SplineInterpolatorImpl {
    ...
    private SplineInterpolatorImpl(List<Double> x, List<Double> y, double[] m) {
        mX = x;
        mY = y;
        mM = m;
    }
     ...
     */
    public static SplineInterpolatorImpl createMonotoneCubicSpline(List<Double> x, List<Double> y) {
        ...
        return new SplineInterpolatorImpl(x, y, m);
    }
