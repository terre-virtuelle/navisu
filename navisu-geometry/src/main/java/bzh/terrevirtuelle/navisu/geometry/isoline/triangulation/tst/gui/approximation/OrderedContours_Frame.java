...
import bzh.terrevirtuelle.navisu.geometry.isoline.triangulation.tst.gui.UtGraphics;
...
public class OrderedContours_Frame {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("OrderedContours_Frame");
