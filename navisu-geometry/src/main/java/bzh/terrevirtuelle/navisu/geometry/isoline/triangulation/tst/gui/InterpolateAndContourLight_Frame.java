 ...
 */
public class InterpolateAndContourLight_Frame {
    ...
    public static void main(String[] args) {
        ...
        final ArrayList<Contour> contours = DT.connectedLines(dt, 5);
        ...
        JFrame frame = new JFrame("InterpolateAndContourLight_Frame");
