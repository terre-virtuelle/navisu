...
public class IzolineTmp {
     ...
     */
    public IzolineTmp(Point_dt A, Point_dt B, int elevation) throws RuntimeException {
    ...
    public IzolineTmp(Point_dt a, Point_dt b) {
        A = a;
        B = b;
        elevation = (int) (a.z + b.z) / 2;
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof IzolineTmp) {
            IzolineTmp line = (IzolineTmp) o;
