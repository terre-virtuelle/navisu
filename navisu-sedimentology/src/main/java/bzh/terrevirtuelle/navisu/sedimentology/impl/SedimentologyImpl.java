 ...
 */
package bzh.terrevirtuelle.navisu.sedimentology.impl;
...
import bzh.terrevirtuelle.navisu.sedimentology.Sedimentology;
import bzh.terrevirtuelle.navisu.sedimentology.SedimentologyServices;
import bzh.terrevirtuelle.navisu.sedimentology.impl.controller.SedimentologyShapefileController;
...
public class SedimentologyImpl
    ...
    private static final String NAME = "Sedimentology";
    private static final String EXTENSION_0 = ".shp";
    protected static final String GROUP = "Shape files";

    protected List<Layer> layers;
    protected static final Logger LOGGER = Logger.getLogger(SedimentologyImpl.class.getName());
